...
| `/Views/Home/Index.cshtml` + `/docs/mock-data.json` | Hardcoded ürün/kategori/banner/prompt verileri | `/Services/Content/StorefrontContentService.cs` + `/Services/Content/HomeContentConfigurationService.cs` | Storefront composition ve fallback content erişimi |
